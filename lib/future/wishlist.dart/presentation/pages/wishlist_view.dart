  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title:Text(
          'Favorites Books',style: gettitlestyle(context),
      ...
      body:ListView.separated(
            ...
            itemBuilder: (BuildContext context, int index) {
              ...
              return ListTile(
                ...
                leading: Image.asset(userlist[index].img!,fit: BoxFit.cover,width: 100,height: 160,),
                title: Text(userlist[index].name??" ",style: getSmallTextStyle(context),),
                subtitle:Text(userlist[index].price??'',style: getSmallTextStyle(context),),
                trailing: Column(
                ...
                Expanded(
                  child: Container(
                    ...
                    child: 
                    Text('Add to Cart',style: getSmallTextStyle(context),),
                  ),
                ),
                  SizedBox(height: 12,)
                ],),
